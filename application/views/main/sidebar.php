<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link" href="<?php echo base_url()?>main/supplier"
        ...
        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                aria-expanded="false"><i class="fas fa-cart-plus"></i><span
                    class="hide-menu">Pembelian </span></a>
            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                <li class="sidebar-item"><a href="<?php echo base_url()?>pembelian/riwayat" class="sidebar-link"><span
                            class="hide-menu"> Riwayat
                        </span></a>
                </li>
                <li class="sidebar-item"><a href="<?php echo base_url()?>pembelian/pembelian" class="sidebar-link"><span
            ...
            <ul aria-expanded="false" class="collapse first-level base-level-line">
                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)"
                    ...
                    <ul aria-expanded="false" class="collapse second-level base-level-line">
                        <li class="sidebar-item"><a href="<?php echo base_url()?>master/product" class="sidebar-link"><span
                                    class="hide-menu"> Produk</span></a></li>
                        <li class="sidebar-item"><a href="<?php echo base_url()?>master/category" class="sidebar-link"><span
                                    class="hide-menu"> Golongan</span></a></li>
                        <li class="sidebar-item"><a href="<?php echo base_url()?>master/unit" class="sidebar-link"><span
                                    class="hide-menu"> Satuan</span></a></li>
                        <li class="sidebar-item"><a href="<?php echo base_url()?>master/company" class="sidebar-link"><span
